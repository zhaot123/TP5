...
class Slide extends Controller
{
    ...
    //添加
    public function add(Request $request, SlideM $model, SlideV $validate)
    {
        if ($request->isPost()) {
            $param = $request->param();
    ...
    //修改
    public function edit($id, Request $request, SlideM $model, SlideV $validate)
    {
