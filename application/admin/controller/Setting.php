...
use app\admin\model\SettingM;
use app\admin\model\SettingGroupM;
...
class Setting extends Controller
{
    ...
    //列表
    public function index(Request $request, SettingM $model)
    {
        $param = $request->param();
    ...
    //添加
    public function add(Request $request, SettingM $model, SettingValidate $validate)
    {
        if ($request->isPost()) {
            $param           = $request->param();
            ...
            //自动更新配置文件
            $group = SettingGroupM::get($result->setting_group_id);
        ...
        $this->assign([
            'setting_group_list' => SettingGroupM::all(),
    ...
    //修改
    public function edit($id, Request $request, SettingM $model, SettingValidate $validate)
    {
        ...
        if ($request->isPost()) {
            ...
            //自动更新配置文件
            $group = SettingGroupM::get($data->setting_group_id);
            create_setting_file($group);
    ...
    //删除
    public function del($id, SettingM $model)
    {
    ...
    {
        $data = SettingM::where('setting_group_id', $id)->select();
    ...
    //更新设置
    public function update(Request $request, SettingM $model)
    {
        $param = $request->param();
        ...
        //自动更新配置文件
        $group = SettingGroupM::get($config->setting_group_id);
    ...
    //列表
    public function all(Request $request, SettingGroupM $model)
    {
        $param = $request->param();
