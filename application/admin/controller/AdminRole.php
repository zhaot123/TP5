...
class AdminRole extends Controller
{
    ...
    public function index(Request $request, AdminRoleM $model)
    {
    ...
    //添加
    public function add(Request $request, AdminRoleM $model, AdminRoleValidate $validate)
    {
        if ($request->isPost()) {
            $param           = $request->param();
    ...
    //修改
    public function edit($id, Request $request, AdminRoleM $model, AdminRoleValidate $validate)
    {
    ...
    //删除
    public function del($id, AdminRoleM $model)
    {
    ...
    //角色授权
    public function access($id, Request $request, AdminRoleM $model)
    {
        $data = $model::get($id);
        if ($request->isPost()) {
            $param = $request->param();
        ...
        $menu = AdminMenuM::order('sort_id', 'asc')->order('id', 'asc')->column('*', 'id');
    ...
    //启用
    public function enable($id, AdminRoleM $model)
    {
    ...
    //禁用
    public function disable($id, AdminRoleM $model)
    {
