...
class Generate extends Controller
{
    ...
    public function add()
    {
        ...
        $this->assign([
            'table' => (new GenerateRun())->getTable(),
            'menus' => (new GenerateRun())->getMenu(10000),
            'module' => (new GenerateRun())->getModule()//增加
        ]);
    ...
    {
        return success('success', URL_CURRENT, (new GenerateRun())->getTable());
    }


    public function getMenu()
    {
        return success('success', URL_CURRENT, (new GenerateRun())->getMenu(10000));
    }
    ...
    public function getField(Request $request)
    {
        ...
        $data = (new GenerateRun())->getAll($name);
