...
class AdminUser extends Controller
{
    ...
    //列表
    public function index(Request $request, AdminUserM $model)
    {
    ...
    //添加
    public function add(Request $request, AdminUserM $model, AdminUserValidate $validate)
    {
        if ($request->isPost()) {
            $param           = $request->param();
        ...
        $role = AdminRoleM::all(function ($query) {
    ...
    //修改
    public function edit($id, Request $request, AdminUserM $model, AdminUserValidate $validate)
    {
    ...
    //删除
    public function del($id, AdminUserM $model)
    {
    ...
    //启用
    public function enable($id, AdminUserM $model)
    {
    ...
    //禁用
    public function disable($id, AdminUserM $model)
    {
