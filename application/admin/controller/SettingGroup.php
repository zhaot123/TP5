...
class SettingGroup extends Controller
{
    ...
    //列表
    public function index(Request $request, SettingGroupM $model)
    {
        $param = $request->param();
    ...
    //添加
    public function add(Request $request, SettingGroupM $model, SettingGroupValidate $validate)
    {
        if ($request->isPost()) {
            $param           = $request->param();
    ...
    //修改
    public function edit($id, Request $request, SettingGroupM $model, SettingGroupValidate $validate)
    {
    ...
    //删除
    public function del($id, SettingGroupM $model)
    {
    ...
    //生成配置文件，配置文件名为模块名
    public function file($id, SettingGroupM $model)
    {
        $data = $model::get($id);
    ...
    public function menu($id, SettingGroupM $model)
    {
        $data = $model::get($id);

        $have    = AdminMenuM::get(function ($query) use ($data) {
